...
80100b32:	75 d2                	jne    80100b06 <exec+0x56>
  if((pgdir = setupkvm()) == 0)
80100b34:	e8 f7 63 00 00       	call   80106f30 <setupkvm>
...
80100ba3:	e8 a8 61 00 00       	call   80106d50 <allocuvm>
...
80100bd9:	e8 82 60 00 00       	call   80106c60 <loaduvm>
...
80100c1b:	e8 90 62 00 00       	call   80106eb0 <freevm>
  if(ip){
...
80100c62:	e8 e9 60 00 00       	call   80106d50 <allocuvm>
...
80100c81:	31 ff                	xor    %edi,%edi
  clearpteu(pgdir, (char*)(sz - 2*PGSIZE));
80100c83:	e8 48 63 00 00       	call   80106fd0 <clearpteu>
  for(argc = 0; argv[argc]; argc++) {
...
80100cf8:	e8 a3 64 00 00       	call   801071a0 <copyout>
...
80100d11:	e8 9a 61 00 00       	call   80106eb0 <freevm>
...
80100d5d:	89 8d 60 ff ff ff    	mov    %ecx,-0xa0(%ebp)
  if(copyout(pgdir, sp, ustack, (3+argc+1)*4) < 0)
80100d63:	e8 38 64 00 00       	call   801071a0 <copyout>
...
80100dcd:	e8 fe 5c 00 00       	call   80106ad0 <switchuvm>
  freevm(oldpgdir);
80100dd2:	89 3c 24             	mov    %edi,(%esp)
80100dd5:	e8 d6 60 00 00       	call   80106eb0 <freevm>
  return 0;
...
80103043:	83 ec 08             	sub    $0x8,%esp
  switchkvm();
80103046:	e8 75 3a 00 00       	call   80106ac0 <switchkvm>
  seginit();
...
80103081:	e8 2a 3f 00 00       	call   80106fb0 <kvmalloc>
...
80103824:	89 53 18             	mov    %edx,0x18(%ebx)
  *(uint*)sp = (uint)trapret;
80103827:	c7 40 14 e2 58 10 80 	movl   $0x801058e2,0x14(%eax)
  p->context = (struct context*)sp;
...
801039b3:	e8 78 35 00 00       	call   80106f30 <setupkvm>
...
801039d1:	e8 0a 32 00 00       	call   80106be0 <inituvm>
...
80103abb:	e8 10 30 00 00       	call   80106ad0 <switchuvm>
  return 0;
...
80103ada:	e8 71 32 00 00       	call   80106d50 <allocuvm>
...
80103afa:	e8 81 33 00 00       	call   80106e80 <deallocuvm>
...
80103b48:	e8 d3 34 00 00       	call   80107020 <copyuvm>
...
80103f89:	e8 22 2f 00 00       	call   80106eb0 <freevm>
        p->pid = 0;
...
801042aa:	68 e4 78 10 80       	push   $0x801078e4
...
801044e5:	68 ef 78 10 80       	push   $0x801078ef
801044ea:	e8 91 be ff ff       	call   80100380 <panic>
    panic("popcli");
801044ef:	83 ec 0c             	sub    $0xc,%esp
801044f2:	68 06 79 10 80       	push   $0x80107906
...
8010455b:	68 0d 79 10 80       	push   $0x8010790d
...
80104650:	68 15 79 10 80       	push   $0x80107915
...
80104a7c:	8b 14 85 40 79 10 80 	mov    -0x7fef86c0(,%eax,4),%edx
...
80104aa8:	68 1d 79 10 80       	push   $0x8010791d
...
80104c04:	68 bc 79 10 80       	push   $0x801079bc
...
80104c1c:	68 bb 79 10 80       	push   $0x801079bb
...
80104c31:	68 af 79 10 80       	push   $0x801079af
...
80104c4f:	68 be 79 10 80       	push   $0x801079be
80104c54:	e8 27 b7 ff ff       	call   80100380 <panic>
    panic("create: ialloc");
80104c59:	83 ec 0c             	sub    $0xc,%esp
80104c5c:	68 a0 79 10 80       	push   $0x801079a0
...
8010505d:	58                   	pop    %eax
8010505e:	5a                   	pop    %edx
8010505f:	68 bc 79 10 80       	push   $0x801079bc
...
80105078:	68 bb 79 10 80       	push   $0x801079bb
...
80105739:	e8 32 e2 ff ff       	call   80103970 <myproc>
  int ct = 0;
8010573e:	31 c9                	xor    %ecx,%ecx
80105740:	8b 70 04             	mov    0x4(%eax),%esi
80105743:	8d be 00 08 00 00    	lea    0x800(%esi),%edi
80105749:	eb 0c                	jmp    80105757 <sys_numpp+0x27>
8010574b:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
8010574f:	90                   	nop

  for(uint i = 0; i < PDX(KERNBASE); i++)
80105750:	83 c6 04             	add    $0x4,%esi
80105753:	39 fe                	cmp    %edi,%esi
80105755:	74 32                	je     80105789 <sys_numpp+0x59>
  {
    pde = &pgdir[i];
    if(!(*pde & PTE_P))
80105757:	8b 1e                	mov    (%esi),%ebx
80105759:	f6 c3 01             	test   $0x1,%bl
8010575c:	74 f2                	je     80105750 <sys_numpp+0x20>
    {
      continue;
    }
    pgtab = (pte_t*)P2V(PTE_ADDR(*pde));
8010575e:	81 e3 00 f0 ff ff    	and    $0xfffff000,%ebx
80105764:	8d 83 00 00 00 80    	lea    -0x80000000(%ebx),%eax

    for(uint j = 0; j < NPTENTRIES; j++)
8010576a:	81 eb 00 f0 ff 7f    	sub    $0x7ffff000,%ebx
    {
      if(pgtab[j] & PTE_P)
80105770:	8b 10                	mov    (%eax),%edx
80105772:	83 e2 01             	and    $0x1,%edx
      {
        ct++;
80105775:	83 fa 01             	cmp    $0x1,%edx
80105778:	83 d9 ff             	sbb    $0xffffffff,%ecx
    for(uint j = 0; j < NPTENTRIES; j++)
8010577b:	83 c0 04             	add    $0x4,%eax
8010577e:	39 d8                	cmp    %ebx,%eax
80105780:	75 ee                	jne    80105770 <sys_numpp+0x40>
  for(uint i = 0; i < PDX(KERNBASE); i++)
80105782:	83 c6 04             	add    $0x4,%esi
80105785:	39 fe                	cmp    %edi,%esi
80105787:	75 ce                	jne    80105757 <sys_numpp+0x27>
    }
...
801057c6:	e8 c5 e2 ff ff       	call   80103a90 <growproc>
...
8010581a:	8b 55 f4             	mov    -0xc(%ebp),%edx
  ticks0 = ticks;
8010581d:	8b 1d 60 3c 11 80    	mov    0x80113c60,%ebx
  while(ticks - ticks0 < n){
...
8010583d:	e8 fe e7 ff ff       	call   80104040 <sleep>
  while(ticks - ticks0 < n){
...
80105865:	e8 d6 ec ff ff       	call   80104540 <release>
  }
  release(&tickslock);
  return 0;
}
...
80105888:	e8 b3 ec ff ff       	call   80104540 <release>
  return 0;
...
8010593e:	00 00 ef 
  initlock(&tickslock, "time");
80105941:	68 01 7a 10 80       	push   $0x80107a01
...
801059c4:	ff 24 85 a8 7a 10 80 	jmp    *-0x7fef8558(,%eax,4)
...
80105aa5:	68 64 7a 10 80       	push   $0x80107a64
...
80105af7:	68 0c 7a 10 80       	push   $0x80107a0c
...
80105c13:	68 30 7a 10 80       	push   $0x80107a30
80105c18:	e8 83 aa ff ff       	call   801006a0 <cprintf>
      panic("trap");
80105c1d:	83 c4 14             	add    $0x14,%esp
80105c20:	68 06 7a 10 80       	push   $0x80107a06
...
80105ccc:	83 ec 08             	sub    $0x8,%esp
  for(p="xv6...\n"; *p; p++)
80105ccf:	bf 28 7b 10 80       	mov    $0x80107b28,%edi
...
80105db7:	6a 00                	push   $0x0
  jmp alltraps
80105db9:	e9 0c fb ff ff       	jmp    801058ca <alltraps>
...
80105dc0:	6a 01                	push   $0x1
  jmp alltraps
80105dc2:	e9 03 fb ff ff       	jmp    801058ca <alltraps>
...
80105dc9:	6a 02                	push   $0x2
  jmp alltraps
80105dcb:	e9 fa fa ff ff       	jmp    801058ca <alltraps>
...
80105dd2:	6a 03                	push   $0x3
  jmp alltraps
80105dd4:	e9 f1 fa ff ff       	jmp    801058ca <alltraps>
...
80105ddb:	6a 04                	push   $0x4
  jmp alltraps
80105ddd:	e9 e8 fa ff ff       	jmp    801058ca <alltraps>
...
80105de4:	6a 05                	push   $0x5
  jmp alltraps
80105de6:	e9 df fa ff ff       	jmp    801058ca <alltraps>
...
80105e14:	6a 0b                	push   $0xb
  jmp alltraps
80105e16:	e9 af fa ff ff       	jmp    801058ca <alltraps>
...
80105e29:	6a 0e                	push   $0xe
  jmp alltraps
80105e2b:	e9 9a fa ff ff       	jmp    801058ca <alltraps>
...
80105e5d:	6a 14                	push   $0x14
  jmp alltraps
80105e5f:	e9 66 fa ff ff       	jmp    801058ca <alltraps>
...
80105e66:	6a 15                	push   $0x15
  jmp alltraps
80105e68:	e9 5d fa ff ff       	jmp    801058ca <alltraps>
...
80105e6f:	6a 16                	push   $0x16
  jmp alltraps
80105e71:	e9 54 fa ff ff       	jmp    801058ca <alltraps>
...
80105e78:	6a 17                	push   $0x17
  jmp alltraps
80105e7a:	e9 4b fa ff ff       	jmp    801058ca <alltraps>
...
80105e81:	6a 18                	push   $0x18
  jmp alltraps
80105e83:	e9 42 fa ff ff       	jmp    801058ca <alltraps>
...
80105e8a:	6a 19                	push   $0x19
  jmp alltraps
80105e8c:	e9 39 fa ff ff       	jmp    801058ca <alltraps>
...
80105e93:	6a 1a                	push   $0x1a
  jmp alltraps
80105e95:	e9 30 fa ff ff       	jmp    801058ca <alltraps>
...
80105e9c:	6a 1b                	push   $0x1b
  jmp alltraps
80105e9e:	e9 27 fa ff ff       	jmp    801058ca <alltraps>
...
80105ea5:	6a 1c                	push   $0x1c
  jmp alltraps
80105ea7:	e9 1e fa ff ff       	jmp    801058ca <alltraps>
...
80105eae:	6a 1d                	push   $0x1d
  jmp alltraps
80105eb0:	e9 15 fa ff ff       	jmp    801058ca <alltraps>
...
80105eb7:	6a 1e                	push   $0x1e
  jmp alltraps
80105eb9:	e9 0c fa ff ff       	jmp    801058ca <alltraps>
...
80105ec0:	6a 1f                	push   $0x1f
  jmp alltraps
80105ec2:	e9 03 fa ff ff       	jmp    801058ca <alltraps>
...
80105ec9:	6a 20                	push   $0x20
  jmp alltraps
80105ecb:	e9 fa f9 ff ff       	jmp    801058ca <alltraps>
...
80105ed2:	6a 21                	push   $0x21
  jmp alltraps
80105ed4:	e9 f1 f9 ff ff       	jmp    801058ca <alltraps>
...
80105edb:	6a 22                	push   $0x22
  jmp alltraps
80105edd:	e9 e8 f9 ff ff       	jmp    801058ca <alltraps>
...
80105ee4:	6a 23                	push   $0x23
  jmp alltraps
80105ee6:	e9 df f9 ff ff       	jmp    801058ca <alltraps>
...
80105eed:	6a 24                	push   $0x24
  jmp alltraps
80105eef:	e9 d6 f9 ff ff       	jmp    801058ca <alltraps>
...
80105ef6:	6a 25                	push   $0x25
  jmp alltraps
80105ef8:	e9 cd f9 ff ff       	jmp    801058ca <alltraps>
...
80105eff:	6a 26                	push   $0x26
  jmp alltraps
80105f01:	e9 c4 f9 ff ff       	jmp    801058ca <alltraps>
...
80105f08:	6a 27                	push   $0x27
  jmp alltraps
80105f0a:	e9 bb f9 ff ff       	jmp    801058ca <alltraps>
...
80105f11:	6a 28                	push   $0x28
  jmp alltraps
80105f13:	e9 b2 f9 ff ff       	jmp    801058ca <alltraps>
...
80105f1a:	6a 29                	push   $0x29
  jmp alltraps
80105f1c:	e9 a9 f9 ff ff       	jmp    801058ca <alltraps>
...
80105f23:	6a 2a                	push   $0x2a
  jmp alltraps
80105f25:	e9 a0 f9 ff ff       	jmp    801058ca <alltraps>
...
80105f2c:	6a 2b                	push   $0x2b
  jmp alltraps
80105f2e:	e9 97 f9 ff ff       	jmp    801058ca <alltraps>
...
80105f35:	6a 2c                	push   $0x2c
  jmp alltraps
80105f37:	e9 8e f9 ff ff       	jmp    801058ca <alltraps>
...
80105f3e:	6a 2d                	push   $0x2d
  jmp alltraps
80105f40:	e9 85 f9 ff ff       	jmp    801058ca <alltraps>
...
80105f47:	6a 2e                	push   $0x2e
  jmp alltraps
80105f49:	e9 7c f9 ff ff       	jmp    801058ca <alltraps>
...
80105f50:	6a 2f                	push   $0x2f
  jmp alltraps
80105f52:	e9 73 f9 ff ff       	jmp    801058ca <alltraps>
...
80105f59:	6a 30                	push   $0x30
  jmp alltraps
80105f5b:	e9 6a f9 ff ff       	jmp    801058ca <alltraps>
...
80105f62:	6a 31                	push   $0x31
  jmp alltraps
80105f64:	e9 61 f9 ff ff       	jmp    801058ca <alltraps>
...
80105f6b:	6a 32                	push   $0x32
  jmp alltraps
80105f6d:	e9 58 f9 ff ff       	jmp    801058ca <alltraps>
...
80105f74:	6a 33                	push   $0x33
  jmp alltraps
80105f76:	e9 4f f9 ff ff       	jmp    801058ca <alltraps>
...
80105f7d:	6a 34                	push   $0x34
  jmp alltraps
80105f7f:	e9 46 f9 ff ff       	jmp    801058ca <alltraps>
...
80105f86:	6a 35                	push   $0x35
  jmp alltraps
80105f88:	e9 3d f9 ff ff       	jmp    801058ca <alltraps>
...
80105f8f:	6a 36                	push   $0x36
  jmp alltraps
80105f91:	e9 34 f9 ff ff       	jmp    801058ca <alltraps>
...
80105f98:	6a 37                	push   $0x37
  jmp alltraps
80105f9a:	e9 2b f9 ff ff       	jmp    801058ca <alltraps>
...
80105fa1:	6a 38                	push   $0x38
  jmp alltraps
80105fa3:	e9 22 f9 ff ff       	jmp    801058ca <alltraps>
...
80105faa:	6a 39                	push   $0x39
  jmp alltraps
80105fac:	e9 19 f9 ff ff       	jmp    801058ca <alltraps>
...
80105fb3:	6a 3a                	push   $0x3a
  jmp alltraps
80105fb5:	e9 10 f9 ff ff       	jmp    801058ca <alltraps>
...
80105fbc:	6a 3b                	push   $0x3b
  jmp alltraps
80105fbe:	e9 07 f9 ff ff       	jmp    801058ca <alltraps>
...
80105fc5:	6a 3c                	push   $0x3c
  jmp alltraps
80105fc7:	e9 fe f8 ff ff       	jmp    801058ca <alltraps>
...
80105fce:	6a 3d                	push   $0x3d
  jmp alltraps
80105fd0:	e9 f5 f8 ff ff       	jmp    801058ca <alltraps>
...
80105fd7:	6a 3e                	push   $0x3e
  jmp alltraps
80105fd9:	e9 ec f8 ff ff       	jmp    801058ca <alltraps>
...
80105fe0:	6a 3f                	push   $0x3f
  jmp alltraps
80105fe2:	e9 e3 f8 ff ff       	jmp    801058ca <alltraps>
...
80105fe9:	6a 40                	push   $0x40
  jmp alltraps
80105feb:	e9 da f8 ff ff       	jmp    801058ca <alltraps>
...
80105ff2:	6a 41                	push   $0x41
  jmp alltraps
80105ff4:	e9 d1 f8 ff ff       	jmp    801058ca <alltraps>
...
80105ffb:	6a 42                	push   $0x42
  jmp alltraps
80105ffd:	e9 c8 f8 ff ff       	jmp    801058ca <alltraps>
...
80106004:	6a 43                	push   $0x43
  jmp alltraps
80106006:	e9 bf f8 ff ff       	jmp    801058ca <alltraps>
...
8010600d:	6a 44                	push   $0x44
  jmp alltraps
8010600f:	e9 b6 f8 ff ff       	jmp    801058ca <alltraps>
...
80106016:	6a 45                	push   $0x45
  jmp alltraps
80106018:	e9 ad f8 ff ff       	jmp    801058ca <alltraps>
...
8010601f:	6a 46                	push   $0x46
  jmp alltraps
80106021:	e9 a4 f8 ff ff       	jmp    801058ca <alltraps>
...
80106028:	6a 47                	push   $0x47
  jmp alltraps
8010602a:	e9 9b f8 ff ff       	jmp    801058ca <alltraps>
...
80106031:	6a 48                	push   $0x48
  jmp alltraps
80106033:	e9 92 f8 ff ff       	jmp    801058ca <alltraps>
...
8010603a:	6a 49                	push   $0x49
  jmp alltraps
8010603c:	e9 89 f8 ff ff       	jmp    801058ca <alltraps>
...
80106043:	6a 4a                	push   $0x4a
  jmp alltraps
80106045:	e9 80 f8 ff ff       	jmp    801058ca <alltraps>
...
8010604c:	6a 4b                	push   $0x4b
  jmp alltraps
8010604e:	e9 77 f8 ff ff       	jmp    801058ca <alltraps>
...
80106055:	6a 4c                	push   $0x4c
  jmp alltraps
80106057:	e9 6e f8 ff ff       	jmp    801058ca <alltraps>
...
8010605e:	6a 4d                	push   $0x4d
  jmp alltraps
80106060:	e9 65 f8 ff ff       	jmp    801058ca <alltraps>
...
80106067:	6a 4e                	push   $0x4e
  jmp alltraps
80106069:	e9 5c f8 ff ff       	jmp    801058ca <alltraps>
...
80106070:	6a 4f                	push   $0x4f
  jmp alltraps
80106072:	e9 53 f8 ff ff       	jmp    801058ca <alltraps>
...
80106079:	6a 50                	push   $0x50
  jmp alltraps
8010607b:	e9 4a f8 ff ff       	jmp    801058ca <alltraps>
...
80106082:	6a 51                	push   $0x51
  jmp alltraps
80106084:	e9 41 f8 ff ff       	jmp    801058ca <alltraps>
...
80106094:	6a 53                	push   $0x53
  jmp alltraps
80106096:	e9 2f f8 ff ff       	jmp    801058ca <alltraps>
...
8010609d:	6a 54                	push   $0x54
  jmp alltraps
8010609f:	e9 26 f8 ff ff       	jmp    801058ca <alltraps>
...
801060a6:	6a 55                	push   $0x55
  jmp alltraps
801060a8:	e9 1d f8 ff ff       	jmp    801058ca <alltraps>
...
801060af:	6a 56                	push   $0x56
  jmp alltraps
801060b1:	e9 14 f8 ff ff       	jmp    801058ca <alltraps>
...
801060b8:	6a 57                	push   $0x57
  jmp alltraps
801060ba:	e9 0b f8 ff ff       	jmp    801058ca <alltraps>
...
801060c1:	6a 58                	push   $0x58
  jmp alltraps
801060c3:	e9 02 f8 ff ff       	jmp    801058ca <alltraps>
...
801060ca:	6a 59                	push   $0x59
  jmp alltraps
801060cc:	e9 f9 f7 ff ff       	jmp    801058ca <alltraps>
...
801060d3:	6a 5a                	push   $0x5a
  jmp alltraps
801060d5:	e9 f0 f7 ff ff       	jmp    801058ca <alltraps>
...
801060dc:	6a 5b                	push   $0x5b
  jmp alltraps
801060de:	e9 e7 f7 ff ff       	jmp    801058ca <alltraps>
...
801060e5:	6a 5c                	push   $0x5c
  jmp alltraps
801060e7:	e9 de f7 ff ff       	jmp    801058ca <alltraps>
...
801060ee:	6a 5d                	push   $0x5d
  jmp alltraps
801060f0:	e9 d5 f7 ff ff       	jmp    801058ca <alltraps>
...
8010613f:	6a 66                	push   $0x66
  jmp alltraps
80106141:	e9 84 f7 ff ff       	jmp    801058ca <alltraps>
...
80106148:	6a 67                	push   $0x67
  jmp alltraps
8010614a:	e9 7b f7 ff ff       	jmp    801058ca <alltraps>
...
80106151:	6a 68                	push   $0x68
  jmp alltraps
80106153:	e9 72 f7 ff ff       	jmp    801058ca <alltraps>
...
8010615a:	6a 69                	push   $0x69
  jmp alltraps
8010615c:	e9 69 f7 ff ff       	jmp    801058ca <alltraps>
...
80106163:	6a 6a                	push   $0x6a
  jmp alltraps
80106165:	e9 60 f7 ff ff       	jmp    801058ca <alltraps>
...
8010616c:	6a 6b                	push   $0x6b
  jmp alltraps
8010616e:	e9 57 f7 ff ff       	jmp    801058ca <alltraps>
...
80106175:	6a 6c                	push   $0x6c
  jmp alltraps
80106177:	e9 4e f7 ff ff       	jmp    801058ca <alltraps>
...
8010617e:	6a 6d                	push   $0x6d
  jmp alltraps
80106180:	e9 45 f7 ff ff       	jmp    801058ca <alltraps>
...
80106187:	6a 6e                	push   $0x6e
  jmp alltraps
80106189:	e9 3c f7 ff ff       	jmp    801058ca <alltraps>
...
80106190:	6a 6f                	push   $0x6f
  jmp alltraps
80106192:	e9 33 f7 ff ff       	jmp    801058ca <alltraps>
...
80106199:	6a 70                	push   $0x70
  jmp alltraps
8010619b:	e9 2a f7 ff ff       	jmp    801058ca <alltraps>
...
801061a2:	6a 71                	push   $0x71
  jmp alltraps
801061a4:	e9 21 f7 ff ff       	jmp    801058ca <alltraps>
...
801061ab:	6a 72                	push   $0x72
  jmp alltraps
801061ad:	e9 18 f7 ff ff       	jmp    801058ca <alltraps>
...
801061b4:	6a 73                	push   $0x73
  jmp alltraps
801061b6:	e9 0f f7 ff ff       	jmp    801058ca <alltraps>
...
801061bd:	6a 74                	push   $0x74
  jmp alltraps
801061bf:	e9 06 f7 ff ff       	jmp    801058ca <alltraps>
...
801061c6:	6a 75                	push   $0x75
  jmp alltraps
801061c8:	e9 fd f6 ff ff       	jmp    801058ca <alltraps>
...
801061cf:	6a 76                	push   $0x76
  jmp alltraps
801061d1:	e9 f4 f6 ff ff       	jmp    801058ca <alltraps>
...
801061d8:	6a 77                	push   $0x77
  jmp alltraps
801061da:	e9 eb f6 ff ff       	jmp    801058ca <alltraps>
...
801061e1:	6a 78                	push   $0x78
  jmp alltraps
801061e3:	e9 e2 f6 ff ff       	jmp    801058ca <alltraps>
...
801061ea:	6a 79                	push   $0x79
  jmp alltraps
801061ec:	e9 d9 f6 ff ff       	jmp    801058ca <alltraps>
...
801061f3:	6a 7a                	push   $0x7a
  jmp alltraps
801061f5:	e9 d0 f6 ff ff       	jmp    801058ca <alltraps>
...
801061fc:	6a 7b                	push   $0x7b
  jmp alltraps
801061fe:	e9 c7 f6 ff ff       	jmp    801058ca <alltraps>
...
80106205:	6a 7c                	push   $0x7c
  jmp alltraps
80106207:	e9 be f6 ff ff       	jmp    801058ca <alltraps>
...
8010620e:	6a 7d                	push   $0x7d
  jmp alltraps
80106210:	e9 b5 f6 ff ff       	jmp    801058ca <alltraps>
...
80106217:	6a 7e                	push   $0x7e
  jmp alltraps
80106219:	e9 ac f6 ff ff       	jmp    801058ca <alltraps>
...
80106220:	6a 7f                	push   $0x7f
  jmp alltraps
80106222:	e9 a3 f6 ff ff       	jmp    801058ca <alltraps>
...
80106235:	68 81 00 00 00       	push   $0x81
  jmp alltraps
8010623a:	e9 8b f6 ff ff       	jmp    801058ca <alltraps>
...
80106241:	68 82 00 00 00       	push   $0x82
  jmp alltraps
80106246:	e9 7f f6 ff ff       	jmp    801058ca <alltraps>
...
80106259:	68 84 00 00 00       	push   $0x84
  jmp alltraps
8010625e:	e9 67 f6 ff ff       	jmp    801058ca <alltraps>
...
80106265:	68 85 00 00 00       	push   $0x85
  jmp alltraps
8010626a:	e9 5b f6 ff ff       	jmp    801058ca <alltraps>
...
8010627d:	68 87 00 00 00       	push   $0x87
  jmp alltraps
80106282:	e9 43 f6 ff ff       	jmp    801058ca <alltraps>
...
80106289:	68 88 00 00 00       	push   $0x88
  jmp alltraps
8010628e:	e9 37 f6 ff ff       	jmp    801058ca <alltraps>
...
801062a1:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
801062a6:	e9 1f f6 ff ff       	jmp    801058ca <alltraps>
...
801062ad:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
801062b2:	e9 13 f6 ff ff       	jmp    801058ca <alltraps>
...
801062c5:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
801062ca:	e9 fb f5 ff ff       	jmp    801058ca <alltraps>
...
801062d1:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
801062d6:	e9 ef f5 ff ff       	jmp    801058ca <alltraps>
...
801062e9:	68 90 00 00 00       	push   $0x90
  jmp alltraps
801062ee:	e9 d7 f5 ff ff       	jmp    801058ca <alltraps>
...
801062f5:	68 91 00 00 00       	push   $0x91
  jmp alltraps
801062fa:	e9 cb f5 ff ff       	jmp    801058ca <alltraps>
...
8010630d:	68 93 00 00 00       	push   $0x93
  jmp alltraps
80106312:	e9 b3 f5 ff ff       	jmp    801058ca <alltraps>
...
80106319:	68 94 00 00 00       	push   $0x94
  jmp alltraps
8010631e:	e9 a7 f5 ff ff       	jmp    801058ca <alltraps>
...
80106331:	68 96 00 00 00       	push   $0x96
  jmp alltraps
80106336:	e9 8f f5 ff ff       	jmp    801058ca <alltraps>
...
8010633d:	68 97 00 00 00       	push   $0x97
  jmp alltraps
80106342:	e9 83 f5 ff ff       	jmp    801058ca <alltraps>
...
80106355:	68 99 00 00 00       	push   $0x99
  jmp alltraps
8010635a:	e9 6b f5 ff ff       	jmp    801058ca <alltraps>
...
80106361:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
80106366:	e9 5f f5 ff ff       	jmp    801058ca <alltraps>
...
80106379:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
8010637e:	e9 47 f5 ff ff       	jmp    801058ca <alltraps>
...
80106385:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
8010638a:	e9 3b f5 ff ff       	jmp    801058ca <alltraps>
...
8010639d:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
801063a2:	e9 23 f5 ff ff       	jmp    801058ca <alltraps>
...
801063a9:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
801063ae:	e9 17 f5 ff ff       	jmp    801058ca <alltraps>
...
801063c1:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
801063c6:	e9 ff f4 ff ff       	jmp    801058ca <alltraps>
...
801063cd:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
801063d2:	e9 f3 f4 ff ff       	jmp    801058ca <alltraps>
...
801063e5:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
801063ea:	e9 db f4 ff ff       	jmp    801058ca <alltraps>
...
801063f1:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
801063f6:	e9 cf f4 ff ff       	jmp    801058ca <alltraps>
...
80106409:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
8010640e:	e9 b7 f4 ff ff       	jmp    801058ca <alltraps>
...
80106415:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
8010641a:	e9 ab f4 ff ff       	jmp    801058ca <alltraps>
...
8010642d:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
80106432:	e9 93 f4 ff ff       	jmp    801058ca <alltraps>
...
80106439:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
8010643e:	e9 87 f4 ff ff       	jmp    801058ca <alltraps>
...
80106451:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
80106456:	e9 6f f4 ff ff       	jmp    801058ca <alltraps>
...
8010645d:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
80106462:	e9 63 f4 ff ff       	jmp    801058ca <alltraps>
...
80106475:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
8010647a:	e9 4b f4 ff ff       	jmp    801058ca <alltraps>
...
80106481:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
80106486:	e9 3f f4 ff ff       	jmp    801058ca <alltraps>
...
801068cf:	68 e6 74 10 80       	push   $0x801074e6
...
801069bd:	68 30 7b 10 80       	push   $0x80107b30
...
80106a67:	8b 75 08             	mov    0x8(%ebp),%esi
80106a6a:	53                   	push   %ebx
80106a6b:	8d be 00 08 00 00    	lea    0x800(%esi),%edi
80106a71:	eb 0c                	jmp    80106a7f <ppnums+0x1f>
80106a73:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80106a77:	90                   	nop
  for(uint i = 0; i < PDX(KERNBASE); i++)
80106a78:	83 c6 04             	add    $0x4,%esi
80106a7b:	39 fe                	cmp    %edi,%esi
80106a7d:	74 3a                	je     80106ab9 <ppnums+0x59>
    if(!(*pde & PTE_P))
80106a7f:	8b 1e                	mov    (%esi),%ebx
80106a81:	f6 c3 01             	test   $0x1,%bl
80106a84:	74 f2                	je     80106a78 <ppnums+0x18>
    pgtab = (pte_t*)P2V(PTE_ADDR(*pde));
80106a86:	81 e3 00 f0 ff ff    	and    $0xfffff000,%ebx
80106a8c:	8d 83 00 00 00 80    	lea    -0x80000000(%ebx),%eax
    for(uint j = 0; j < NPTENTRIES; j++)
80106a92:	81 eb 00 f0 ff 7f    	sub    $0x7ffff000,%ebx
80106a98:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
80106a9f:	90                   	nop
      if(pgtab[j] & PTE_P)
80106aa0:	8b 10                	mov    (%eax),%edx
80106aa2:	83 e2 01             	and    $0x1,%edx
        ct++;
80106aa5:	83 fa 01             	cmp    $0x1,%edx
80106aa8:	83 d9 ff             	sbb    $0xffffffff,%ecx
    for(uint j = 0; j < NPTENTRIES; j++)
80106aab:	83 c0 04             	add    $0x4,%eax
80106aae:	39 d8                	cmp    %ebx,%eax
80106ab0:	75 ee                	jne    80106aa0 <ppnums+0x40>
  for(uint i = 0; i < PDX(KERNBASE); i++)
80106ab2:	83 c6 04             	add    $0x4,%esi
80106ab5:	39 fe                	cmp    %edi,%esi
80106ab7:	75 c6                	jne    80106a7f <ppnums+0x1f>
}
80106ab9:	5b                   	pop    %ebx
80106aba:	89 c8                	mov    %ecx,%eax
80106abc:	5e                   	pop    %esi
80106abd:	5f                   	pop    %edi
80106abe:	5d                   	pop    %ebp
80106abf:	c3                   	ret    
...
80106b06:	e8 e5 cd ff ff       	call   801038f0 <mycpu>
...
80106b18:	e8 d3 cd ff ff       	call   801038f0 <mycpu>
...
80106b61:	e8 8a cd ff ff       	call   801038f0 <mycpu>
80106b66:	80 a0 9d 00 00 00 ef 	andb   $0xef,0x9d(%eax)
  mycpu()->ts.ss0 = SEG_KDATA << 3;
80106b6d:	e8 7e cd ff ff       	call   801038f0 <mycpu>
...
80106b84:	89 58 0c             	mov    %ebx,0xc(%eax)
  mycpu()->ts.iomb = (ushort) 0xFFFF;
80106b87:	e8 64 cd ff ff       	call   801038f0 <mycpu>
...
80106bfb:	77 4b                	ja     80106c48 <inituvm+0x68>
  mem = kalloc();
80106bfd:	e8 7e ba ff ff       	call   80102680 <kalloc>
  memset(mem, 0, PGSIZE);
...
80106c0f:	e8 4c da ff ff       	call   80104660 <memset>
...
80106c28:	e8 b3 fc ff ff       	call   801068e0 <mappages>
  memmove(mem, init, sz);
80106c2d:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80106c30:	89 75 10             	mov    %esi,0x10(%ebp)
80106c33:	83 c4 10             	add    $0x10,%esp
80106c36:	89 5d 08             	mov    %ebx,0x8(%ebp)
80106c39:	89 45 0c             	mov    %eax,0xc(%ebp)
}
...
80106c42:	5d                   	pop    %ebp
  memmove(mem, init, sz);
80106c43:	e9 b8 da ff ff       	jmp    80104700 <memmove>
    panic("inituvm: more than a page");
80106c48:	83 ec 0c             	sub    $0xc,%esp
80106c4b:	68 75 7b 10 80       	push   $0x80107b75
80106c50:	e8 2b 97 ff ff       	call   80100380 <panic>
80106c55:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
...
80106c6c:	8b 75 18             	mov    0x18(%ebp),%esi
  if((uint) addr % PGSIZE != 0)
80106c6f:	a9 ff 0f 00 00       	test   $0xfff,%eax
80106c74:	0f 85 bb 00 00 00    	jne    80106d35 <loaduvm+0xd5>
  for(i = 0; i < sz; i += PGSIZE){
80106c7a:	01 f0                	add    %esi,%eax
80106c7c:	89 f3                	mov    %esi,%ebx
80106c7e:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    if(readi(ip, P2V(pa), offset+i, n) != n)
80106c81:	8b 45 14             	mov    0x14(%ebp),%eax
80106c84:	01 f0                	add    %esi,%eax
80106c86:	89 45 e0             	mov    %eax,-0x20(%ebp)
  for(i = 0; i < sz; i += PGSIZE){
80106c89:	85 f6                	test   %esi,%esi
80106c8b:	0f 84 87 00 00 00    	je     80106d18 <loaduvm+0xb8>
80106c91:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  pde = &pgdir[PDX(va)];
80106c98:	8b 45 e4             	mov    -0x1c(%ebp),%eax
  if(*pde & PTE_P){
80106c9b:	8b 4d 08             	mov    0x8(%ebp),%ecx
80106c9e:	29 d8                	sub    %ebx,%eax
  pde = &pgdir[PDX(va)];
80106ca0:	89 c2                	mov    %eax,%edx
80106ca2:	c1 ea 16             	shr    $0x16,%edx
  if(*pde & PTE_P){
80106ca5:	8b 14 91             	mov    (%ecx,%edx,4),%edx
80106ca8:	f6 c2 01             	test   $0x1,%dl
80106cab:	75 13                	jne    80106cc0 <loaduvm+0x60>
      panic("loaduvm: address should exist");
80106cad:	83 ec 0c             	sub    $0xc,%esp
80106cb0:	68 8f 7b 10 80       	push   $0x80107b8f
80106cb5:	e8 c6 96 ff ff       	call   80100380 <panic>
80106cba:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
  return &pgtab[PTX(va)];
80106cc0:	c1 e8 0a             	shr    $0xa,%eax
    pgtab = (pte_t*)P2V(PTE_ADDR(*pde));
80106cc3:	81 e2 00 f0 ff ff    	and    $0xfffff000,%edx
  return &pgtab[PTX(va)];
80106cc9:	25 fc 0f 00 00       	and    $0xffc,%eax
80106cce:	8d 84 02 00 00 00 80 	lea    -0x80000000(%edx,%eax,1),%eax
    if((pte = walkpgdir(pgdir, addr+i, 0)) == 0)
80106cd5:	85 c0                	test   %eax,%eax
80106cd7:	74 d4                	je     80106cad <loaduvm+0x4d>
    pa = PTE_ADDR(*pte);
80106cd9:	8b 00                	mov    (%eax),%eax
    if(readi(ip, P2V(pa), offset+i, n) != n)
80106cdb:	8b 4d e0             	mov    -0x20(%ebp),%ecx
    if(sz - i < PGSIZE)
80106cde:	bf 00 10 00 00       	mov    $0x1000,%edi
    pa = PTE_ADDR(*pte);
80106ce3:	25 00 f0 ff ff       	and    $0xfffff000,%eax
    if(sz - i < PGSIZE)
80106ce8:	81 fb ff 0f 00 00    	cmp    $0xfff,%ebx
80106cee:	0f 46 fb             	cmovbe %ebx,%edi
    if(readi(ip, P2V(pa), offset+i, n) != n)
80106cf1:	29 d9                	sub    %ebx,%ecx
80106cf3:	05 00 00 00 80       	add    $0x80000000,%eax
80106cf8:	57                   	push   %edi
80106cf9:	51                   	push   %ecx
80106cfa:	50                   	push   %eax
80106cfb:	ff 75 10             	push   0x10(%ebp)
80106cfe:	e8 8d ad ff ff       	call   80101a90 <readi>
80106d03:	83 c4 10             	add    $0x10,%esp
80106d06:	39 f8                	cmp    %edi,%eax
80106d08:	75 1e                	jne    80106d28 <loaduvm+0xc8>
  for(i = 0; i < sz; i += PGSIZE){
80106d0a:	81 eb 00 10 00 00    	sub    $0x1000,%ebx
80106d10:	89 f0                	mov    %esi,%eax
80106d12:	29 d8                	sub    %ebx,%eax
80106d14:	39 c6                	cmp    %eax,%esi
80106d16:	77 80                	ja     80106c98 <loaduvm+0x38>
}
80106d18:	8d 65 f4             	lea    -0xc(%ebp),%esp
  return 0;
80106d1b:	31 c0                	xor    %eax,%eax
}
80106d1d:	5b                   	pop    %ebx
80106d1e:	5e                   	pop    %esi
80106d1f:	5f                   	pop    %edi
...
80106d38:	68 30 7c 10 80       	push   $0x80107c30
...
80106d56:	83 ec 1c             	sub    $0x1c,%esp
  if(newsz >= KERNBASE)
80106d59:	8b 45 10             	mov    0x10(%ebp),%eax
{
80106d5c:	8b 7d 08             	mov    0x8(%ebp),%edi
  if(newsz >= KERNBASE)
80106d5f:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80106d62:	85 c0                	test   %eax,%eax
80106d64:	0f 88 b6 00 00 00    	js     80106e20 <allocuvm+0xd0>
  if(newsz < oldsz)
80106d6a:	3b 45 0c             	cmp    0xc(%ebp),%eax
    return oldsz;
80106d6d:	8b 45 0c             	mov    0xc(%ebp),%eax
  if(newsz < oldsz)
80106d70:	0f 82 9a 00 00 00    	jb     80106e10 <allocuvm+0xc0>
  a = PGROUNDUP(oldsz);
80106d76:	8d b0 ff 0f 00 00    	lea    0xfff(%eax),%esi
80106d7c:	81 e6 00 f0 ff ff    	and    $0xfffff000,%esi
  for(; a < newsz; a += PGSIZE){
80106d82:	39 75 10             	cmp    %esi,0x10(%ebp)
80106d85:	77 44                	ja     80106dcb <allocuvm+0x7b>
80106d87:	e9 87 00 00 00       	jmp    80106e13 <allocuvm+0xc3>
...
80106d9b:	e8 c0 d8 ff ff       	call   80104660 <memset>
    if(mappages(pgdir, (char*)a, PGSIZE, V2P(mem), PTE_W|PTE_U) < 0){
80106da0:	58                   	pop    %eax
80106da1:	8d 83 00 00 00 80    	lea    -0x80000000(%ebx),%eax
80106da7:	5a                   	pop    %edx
80106da8:	6a 06                	push   $0x6
80106daa:	b9 00 10 00 00       	mov    $0x1000,%ecx
80106daf:	89 f2                	mov    %esi,%edx
80106db1:	50                   	push   %eax
80106db2:	89 f8                	mov    %edi,%eax
80106db4:	e8 27 fb ff ff       	call   801068e0 <mappages>
80106db9:	83 c4 10             	add    $0x10,%esp
80106dbc:	85 c0                	test   %eax,%eax
80106dbe:	78 78                	js     80106e38 <allocuvm+0xe8>
  for(; a < newsz; a += PGSIZE){
80106dc0:	81 c6 00 10 00 00    	add    $0x1000,%esi
80106dc6:	39 75 10             	cmp    %esi,0x10(%ebp)
80106dc9:	76 48                	jbe    80106e13 <allocuvm+0xc3>
    mem = kalloc();
80106dcb:	e8 b0 b8 ff ff       	call   80102680 <kalloc>
80106dd0:	89 c3                	mov    %eax,%ebx
    if(mem == 0){
80106dd2:	85 c0                	test   %eax,%eax
80106dd4:	75 ba                	jne    80106d90 <allocuvm+0x40>
      cprintf("allocuvm out of memory\n");
80106dd6:	83 ec 0c             	sub    $0xc,%esp
80106dd9:	68 ad 7b 10 80       	push   $0x80107bad
80106dde:	e8 bd 98 ff ff       	call   801006a0 <cprintf>
  if(newsz >= oldsz)
80106de3:	8b 45 0c             	mov    0xc(%ebp),%eax
80106de6:	83 c4 10             	add    $0x10,%esp
80106de9:	39 45 10             	cmp    %eax,0x10(%ebp)
80106dec:	74 32                	je     80106e20 <allocuvm+0xd0>
80106dee:	8b 55 10             	mov    0x10(%ebp),%edx
80106df1:	89 c1                	mov    %eax,%ecx
80106df3:	89 f8                	mov    %edi,%eax
80106df5:	e8 36 fa ff ff       	call   80106830 <deallocuvm.part.0>
      return 0;
80106dfa:	c7 45 e4 00 00 00 00 	movl   $0x0,-0x1c(%ebp)
}
80106e01:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80106e04:	8d 65 f4             	lea    -0xc(%ebp),%esp
80106e07:	5b                   	pop    %ebx
80106e08:	5e                   	pop    %esi
80106e09:	5f                   	pop    %edi
80106e0a:	5d                   	pop    %ebp
...
80106e13:	8b 45 e4             	mov    -0x1c(%ebp),%eax
...
80106e1e:	66 90                	xchg   %ax,%ax
    return 0;
80106e20:	c7 45 e4 00 00 00 00 	movl   $0x0,-0x1c(%ebp)
}
80106e27:	8b 45 e4             	mov    -0x1c(%ebp),%eax
...
80106e3b:	68 c5 7b 10 80       	push   $0x80107bc5
80106e40:	e8 5b 98 ff ff       	call   801006a0 <cprintf>
  if(newsz >= oldsz)
80106e45:	8b 45 0c             	mov    0xc(%ebp),%eax
80106e48:	83 c4 10             	add    $0x10,%esp
80106e4b:	39 45 10             	cmp    %eax,0x10(%ebp)
80106e4e:	74 0c                	je     80106e5c <allocuvm+0x10c>
80106e50:	8b 55 10             	mov    0x10(%ebp),%edx
80106e53:	89 c1                	mov    %eax,%ecx
80106e55:	89 f8                	mov    %edi,%eax
80106e57:	e8 d4 f9 ff ff       	call   80106830 <deallocuvm.part.0>
      kfree(mem);
80106e5c:	83 ec 0c             	sub    $0xc,%esp
80106e5f:	53                   	push   %ebx
80106e60:	e8 5b b6 ff ff       	call   801024c0 <kfree>
      return 0;
80106e65:	c7 45 e4 00 00 00 00 	movl   $0x0,-0x1c(%ebp)
80106e6c:	83 c4 10             	add    $0x10,%esp
}
80106e6f:	8b 45 e4             	mov    -0x1c(%ebp),%eax
...
80106e90:	5d                   	pop    %ebp
80106e91:	e9 9a f9 ff ff       	jmp    80106830 <deallocuvm.part.0>
...
80106ecb:	e8 60 f9 ff ff       	call   80106830 <deallocuvm.part.0>
...
80106efe:	e8 bd b5 ff ff       	call   801024c0 <kfree>
80106f03:	83 c4 10             	add    $0x10,%esp
  for(i = 0; i < NPDENTRIES; i++){
80106f06:	39 df                	cmp    %ebx,%edi
...
80106f13:	5d                   	pop    %ebp
  kfree((char*)pgdir);
80106f14:	e9 a7 b5 ff ff       	jmp    801024c0 <kfree>
    panic("freevm: no pgdir");
80106f19:	83 ec 0c             	sub    $0xc,%esp
80106f1c:	68 e1 7b 10 80       	push   $0x80107be1
...
80106f35:	e8 46 b7 ff ff       	call   80102680 <kalloc>
...
80106f50:	e8 0b d7 ff ff       	call   80104660 <memset>
...
80106f61:	ff 73 0c             	push   0xc(%ebx)
80106f64:	8b 13                	mov    (%ebx),%edx
...
80106fec:	68 f2 7b 10 80       	push   $0x80107bf2
...
80107033:	0f 84 bd 00 00 00    	je     801070f6 <copyuvm+0xd6>
    return 0;
  for(i = 0; i < sz; i += PGSIZE){
80107039:	8b 4d 0c             	mov    0xc(%ebp),%ecx
8010703c:	85 c9                	test   %ecx,%ecx
8010703e:	0f 84 b2 00 00 00    	je     801070f6 <copyuvm+0xd6>
...
80107062:	68 fc 7b 10 80       	push   $0x80107bfc
...
80107089:	74 d4                	je     8010705f <copyuvm+0x3f>
    if(!(*pte & PTE_P))
8010708b:	8b 00                	mov    (%eax),%eax
8010708d:	a8 01                	test   $0x1,%al
8010708f:	0f 84 9f 00 00 00    	je     80107134 <copyuvm+0x114>
      panic("copyuvm: page not present");
    pa = PTE_ADDR(*pte);
80107095:	89 c7                	mov    %eax,%edi
    flags = PTE_FLAGS(*pte);
80107097:	25 ff 0f 00 00       	and    $0xfff,%eax
8010709c:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    pa = PTE_ADDR(*pte);
8010709f:	81 e7 00 f0 ff ff    	and    $0xfffff000,%edi
    if((mem = kalloc()) == 0)
801070a5:	e8 d6 b5 ff ff       	call   80102680 <kalloc>
801070aa:	89 c3                	mov    %eax,%ebx
801070ac:	85 c0                	test   %eax,%eax
801070ae:	74 64                	je     80107114 <copyuvm+0xf4>
      goto bad;
...
801070f6:	8b 45 e0             	mov    -0x20(%ebp),%eax
...
8010710c:	e8 af b3 ff ff       	call   801024c0 <kfree>
      goto bad;
80107111:	83 c4 10             	add    $0x10,%esp
  freevm(d);
80107114:	83 ec 0c             	sub    $0xc,%esp
80107117:	ff 75 e0             	push   -0x20(%ebp)
8010711a:	e8 91 fd ff ff       	call   80106eb0 <freevm>
  return 0;
8010711f:	c7 45 e0 00 00 00 00 	movl   $0x0,-0x20(%ebp)
...
80107137:	68 16 7c 10 80       	push   $0x80107c16
8010713c:	e8 3f 92 ff ff       	call   80100380 <panic>
...
80107153:	8b 45 0c             	mov    0xc(%ebp),%eax
  if(*pde & PTE_P){
80107156:	8b 55 08             	mov    0x8(%ebp),%edx
  pde = &pgdir[PDX(va)];
80107159:	89 c1                	mov    %eax,%ecx
8010715b:	c1 e9 16             	shr    $0x16,%ecx
  if(*pde & PTE_P){
8010715e:	8b 14 8a             	mov    (%edx,%ecx,4),%edx
80107161:	f6 c2 01             	test   $0x1,%dl
80107164:	0f 84 00 01 00 00    	je     8010726a <uva2ka.cold>
  return &pgtab[PTX(va)];
8010716a:	c1 e8 0c             	shr    $0xc,%eax
    pgtab = (pte_t*)P2V(PTE_ADDR(*pde));
8010716d:	81 e2 00 f0 ff ff    	and    $0xfffff000,%edx
  if((*pte & PTE_P) == 0)
    return 0;
  if((*pte & PTE_U) == 0)
    return 0;
...
80107173:	5d                   	pop    %ebp
  return &pgtab[PTX(va)];
80107174:	25 ff 03 00 00       	and    $0x3ff,%eax
  if((*pte & PTE_P) == 0)
80107179:	8b 84 82 00 00 00 80 	mov    -0x80000000(%edx,%eax,4),%eax
  if((*pte & PTE_U) == 0)
...
8010718f:	83 fa 05             	cmp    $0x5,%edx
80107192:	ba 00 00 00 00       	mov    $0x0,%edx
80107197:	0f 45 c2             	cmovne %edx,%eax
}
8010719a:	c3                   	ret    
...
801071af:	8b 55 10             	mov    0x10(%ebp),%edx
  char *buf, *pa0;
  uint n, va0;

  buf = (char*)p;
  while(len > 0){
801071b2:	85 f6                	test   %esi,%esi
801071b4:	75 51                	jne    80107207 <copyout+0x67>
801071b6:	e9 a5 00 00 00       	jmp    80107260 <copyout+0xc0>
801071bb:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
801071bf:	90                   	nop
  return (char*)P2V(PTE_ADDR(*pte));
801071c0:	81 e3 00 f0 ff ff    	and    $0xfffff000,%ebx
801071c6:	8d 8b 00 00 00 80    	lea    -0x80000000(%ebx),%ecx
    va0 = (uint)PGROUNDDOWN(va);
    pa0 = uva2ka(pgdir, (char*)va0);
    if(pa0 == 0)
801071cc:	81 fb 00 00 00 80    	cmp    $0x80000000,%ebx
801071d2:	74 75                	je     80107249 <copyout+0xa9>
      return -1;
    n = PGSIZE - (va - va0);
801071d4:	89 fb                	mov    %edi,%ebx
    if(n > len)
      n = len;
    memmove(pa0 + (va - va0), buf, n);
801071d6:	89 55 10             	mov    %edx,0x10(%ebp)
    n = PGSIZE - (va - va0);
801071d9:	29 c3                	sub    %eax,%ebx
801071db:	81 c3 00 10 00 00    	add    $0x1000,%ebx
801071e1:	39 f3                	cmp    %esi,%ebx
801071e3:	0f 47 de             	cmova  %esi,%ebx
    memmove(pa0 + (va - va0), buf, n);
801071e6:	29 f8                	sub    %edi,%eax
801071e8:	83 ec 04             	sub    $0x4,%esp
801071eb:	01 c1                	add    %eax,%ecx
801071ed:	53                   	push   %ebx
801071ee:	52                   	push   %edx
801071ef:	51                   	push   %ecx
801071f0:	e8 0b d5 ff ff       	call   80104700 <memmove>
    len -= n;
    buf += n;
801071f5:	8b 55 10             	mov    0x10(%ebp),%edx
    va = va0 + PGSIZE;
801071f8:	8d 87 00 10 00 00    	lea    0x1000(%edi),%eax
  while(len > 0){
801071fe:	83 c4 10             	add    $0x10,%esp
    buf += n;
80107201:	01 da                	add    %ebx,%edx
  while(len > 0){
80107203:	29 de                	sub    %ebx,%esi
80107205:	74 59                	je     80107260 <copyout+0xc0>
  if(*pde & PTE_P){
80107207:	8b 5d 08             	mov    0x8(%ebp),%ebx
  pde = &pgdir[PDX(va)];
8010720a:	89 c1                	mov    %eax,%ecx
    va0 = (uint)PGROUNDDOWN(va);
8010720c:	89 c7                	mov    %eax,%edi
  pde = &pgdir[PDX(va)];
8010720e:	c1 e9 16             	shr    $0x16,%ecx
    va0 = (uint)PGROUNDDOWN(va);
80107211:	81 e7 00 f0 ff ff    	and    $0xfffff000,%edi
  if(*pde & PTE_P){
80107217:	8b 0c 8b             	mov    (%ebx,%ecx,4),%ecx
8010721a:	f6 c1 01             	test   $0x1,%cl
8010721d:	0f 84 4e 00 00 00    	je     80107271 <copyout.cold>
  return &pgtab[PTX(va)];
80107223:	89 fb                	mov    %edi,%ebx
    pgtab = (pte_t*)P2V(PTE_ADDR(*pde));
80107225:	81 e1 00 f0 ff ff    	and    $0xfffff000,%ecx
  return &pgtab[PTX(va)];
8010722b:	c1 eb 0c             	shr    $0xc,%ebx
8010722e:	81 e3 ff 03 00 00    	and    $0x3ff,%ebx
  if((*pte & PTE_P) == 0)
80107234:	8b 9c 99 00 00 00 80 	mov    -0x80000000(%ecx,%ebx,4),%ebx
  if((*pte & PTE_U) == 0)
8010723b:	89 d9                	mov    %ebx,%ecx
8010723d:	83 e1 05             	and    $0x5,%ecx
80107240:	83 f9 05             	cmp    $0x5,%ecx
80107243:	0f 84 77 ff ff ff    	je     801071c0 <copyout+0x20>
  }
  return 0;
}
...
8010726a <uva2ka.cold>:
  if((*pte & PTE_P) == 0)
8010726a:	a1 00 00 00 00       	mov    0x0,%eax
8010726f:	0f 0b                	ud2    

80107271 <copyout.cold>:
80107271:	a1 00 00 00 00       	mov    0x0,%eax
80107276:	0f 0b                	ud2    
