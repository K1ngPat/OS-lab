...
_q2-tc3-hid:     file format elf32-i386
...
main()
{
  ...
  1a:	75 5d                	jne    79 <main+0x79>
        char* ptr1 = shm_attach(6);
  1c:	83 ec 0c             	sub    $0xc,%esp
  1f:	6a 06                	push   $0x6
  21:	e8 8d 03 00 00       	call   3b3 <shm_attach>
        char* ptr2 = shm_attach(9);
  26:	c7 04 24 09 00 00 00 	movl   $0x9,(%esp)
        char* ptr1 = shm_attach(6);
  2d:	89 c6                	mov    %eax,%esi
        char* ptr2 = shm_attach(9);
  2f:	e8 7f 03 00 00       	call   3b3 <shm_attach>
        sleep(50);
  34:	c7 04 24 32 00 00 00 	movl   $0x32,(%esp)
        char* ptr2 = shm_attach(9);
  3b:	89 c3                	mov    %eax,%ebx
        sleep(50);
  3d:	e8 61 03 00 00       	call   3a3 <sleep>
  ...
  56:	ff 33                	push   (%ebx)
  58:	68 bb 07 00 00       	push   $0x7bb
  5d:	6a 01                	push   $0x1
  5f:	e8 1c 04 00 00       	call   480 <printf>
        shm_detach(ptr1);
  64:	89 34 24             	mov    %esi,(%esp)
  67:	e8 4f 03 00 00       	call   3bb <shm_detach>
        shm_detach(ptr2);
  6c:	89 1c 24             	mov    %ebx,(%esp)
  6f:	e8 47 03 00 00       	call   3bb <shm_detach>
        exit();
  ...
  7c:	6a 06                	push   $0x6
  7e:	e8 30 03 00 00       	call   3b3 <shm_attach>
        char* ptr2 = shm_attach(9);
  83:	c7 04 24 09 00 00 00 	movl   $0x9,(%esp)
        char* ptr1 = shm_attach(6);
  8a:	89 c6                	mov    %eax,%esi
        char* ptr2 = shm_attach(9);
  8c:	e8 22 03 00 00       	call   3b3 <shm_attach>
        *(uint*)ptr1 = 17;
  91:	c7 06 11 00 00 00    	movl   $0x11,(%esi)
        *(uint*)ptr2 = 18;
  97:	c7 00 12 00 00 00    	movl   $0x12,(%eax)
        char* ptr2 = shm_attach(9);
  9d:	89 c3                	mov    %eax,%ebx
        shm_detach(ptr1);
  9f:	89 34 24             	mov    %esi,(%esp)
  a2:	e8 14 03 00 00       	call   3bb <shm_detach>
        shm_detach(ptr2);
  a7:	89 1c 24             	mov    %ebx,(%esp)
  aa:	e8 0c 03 00 00       	call   3bb <shm_detach>
        wait();
  af:	e8 67 02 00 00       	call   31b <wait>
    }
    exit();
  b4:	e8 5a 02 00 00       	call   313 <exit>
  b9:	66 90                	xchg   %ax,%ax
  bb:	66 90                	xchg   %ax,%ax
  bd:	66 90                	xchg   %ax,%ax
  bf:	90                   	nop
 ...
 489:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 607:	90                   	nop
          s = "(null)";
 608:	ba ce 07 00 00       	mov    $0x7ce,%edx
        while(*s != 0){
 ...
 621:	a1 e0 0a 00 00       	mov    0xae0,%eax
{
 ...
 661:	5b                   	pop    %ebx
  freep = p;
 662:	89 15 e0 0a 00 00    	mov    %edx,0xae0
}
 668:	5e                   	pop    %esi
 669:	5f                   	pop    %edi
 66a:	5d                   	pop    %ebp
 ...
 699:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 69c:	89 15 e0 0a 00 00    	mov    %edx,0xae0
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6b9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6bc:	8b 3d e0 0a 00 00    	mov    0xae0,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6ff:	73 4f                	jae    750 <malloc+0xa0>
    ...
    if(p == freep)
 701:	8b 3d e0 0a 00 00    	mov    0xae0,%edi
 ...
 72a:	e8 f1 fe ff ff       	call   620 <free>
  return freep;
 72f:	8b 15 e0 0a 00 00    	mov    0xae0,%edx
