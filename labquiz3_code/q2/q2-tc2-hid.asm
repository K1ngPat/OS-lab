...
_q2-tc2-hid:     file format elf32-i386
...
int main()
{
   ...
   e:	51                   	push   %ecx
    int f = fork();
   f:	e8 d7 02 00 00       	call   2eb <fork>

    if (f == 0)
  14:	85 c0                	test   %eax,%eax
  16:	75 2e                	jne    46 <main+0x46>
    {
        char *ptr = shm_attach(8);
  18:	83 ec 0c             	sub    $0xc,%esp
  1b:	6a 08                	push   $0x8
  1d:	e8 71 03 00 00       	call   393 <shm_attach>
        sleep(50);
  22:	c7 04 24 32 00 00 00 	movl   $0x32,(%esp)
        char *ptr = shm_attach(8);
  ...
  49:	6a 45                	push   $0x45
  4b:	e8 43 03 00 00       	call   393 <shm_attach>
        if (ptr == 0)
  ...
  57:	50                   	push   %eax
  58:	50                   	push   %eax
  59:	68 ad 07 00 00       	push   $0x7ad
  5e:	6a 01                	push   $0x1
  60:	e8 fb 03 00 00       	call   460 <printf>
            exit();
  65:	e8 89 02 00 00       	call   2f3 <exit>
            printf(1, "Error: shm_attach failed\n");
  6a:	52                   	push   %edx
  6b:	52                   	push   %edx
  6c:	68 93 07 00 00       	push   $0x793
  71:	6a 01                	push   $0x1
  73:	e8 e8 03 00 00       	call   460 <printf>
        }
        ptr = shm_attach(8);
  78:	c7 04 24 08 00 00 00 	movl   $0x8,(%esp)
  7f:	e8 0f 03 00 00       	call   393 <shm_attach>
        *(uint *)ptr = 17;
  84:	c7 00 11 00 00 00    	movl   $0x11,(%eax)
        wait();
  8a:	e8 6c 02 00 00       	call   2fb <wait>
    }
    exit();
 ...
 469:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 5e7:	90                   	nop
          s = "(null)";
 5e8:	ba cb 07 00 00       	mov    $0x7cb,%edx
        while(*s != 0){
