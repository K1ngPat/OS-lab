...
_q2-tc1-hid:     file format elf32-i386
...
main()
{
   ...
   e:	51                   	push   %ecx
    int f = fork();
   f:	e8 a7 02 00 00       	call   2bb <fork>

    if (f == 0)
  14:	85 c0                	test   %eax,%eax
  16:	75 36                	jne    4e <main+0x4e>
    {
        char *ptr = shm_attach(8);
  18:	83 ec 0c             	sub    $0xc,%esp
  1b:	6a 08                	push   $0x8
  1d:	e8 41 03 00 00       	call   363 <shm_attach>
        sleep(50);
  22:	c7 04 24 32 00 00 00 	movl   $0x32,(%esp)
        char *ptr = shm_attach(8);
  29:	89 c3                	mov    %eax,%ebx
        sleep(50);
  2b:	e8 23 03 00 00       	call   353 <sleep>
        printf(1, "Value: %d\n", *(uint *)ptr);
  30:	83 c4 0c             	add    $0xc,%esp
  33:	ff 33                	push   (%ebx)
  35:	68 58 07 00 00       	push   $0x758
  3a:	6a 01                	push   $0x1
  3c:	e8 ef 03 00 00       	call   430 <printf>
        shm_detach(ptr);
  41:	89 1c 24             	mov    %ebx,(%esp)
  44:	e8 22 03 00 00       	call   36b <shm_detach>
        exit();
  49:	e8 75 02 00 00       	call   2c3 <exit>
    }
    else
    {
        char *ptr = shm_attach(8);
  ...
  51:	6a 08                	push   $0x8
  53:	e8 0b 03 00 00       	call   363 <shm_attach>
        *(uint *)ptr = 17;
  58:	c7 00 11 00 00 00    	movl   $0x11,(%eax)
        shm_detach(ptr);
  5e:	89 04 24             	mov    %eax,(%esp)
  61:	e8 05 03 00 00       	call   36b <shm_detach>
        wait();
  66:	e8 60 02 00 00       	call   2cb <wait>
    }
    exit();
 ...
 439:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 5b7:	90                   	nop
          s = "(null)";
 5b8:	ba 63 07 00 00       	mov    $0x763,%edx
        while(*s != 0){
