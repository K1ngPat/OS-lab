...
801024d2:	81 fb 10 55 11 80    	cmp    $0x80115510,%ebx
...
80102602:	5e                   	pop    %esi
80102603:	5d                   	pop    %ebp
  allocate_shared_pages();    // no need to change anything here
80102604:	e9 07 4c 00 00       	jmp    80107210 <allocate_shared_pages>
...
80103077:	68 10 55 11 80       	push   $0x80115510
...
80103e34:	75 e4                	jne    80103e1a <exit+0x8a>
  shared_memory_cleanup(curproc);
80103e36:	83 ec 0c             	sub    $0xc,%esp
80103e39:	53                   	push   %ebx
80103e3a:	e8 01 34 00 00       	call   80107240 <shared_memory_cleanup>
      p->parent = initproc;
80103e3f:	8b 0d 54 3c 11 80    	mov    0x80113c54,%ecx
80103e45:	83 c4 10             	add    $0x10,%esp
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103e48:	ba 54 1d 11 80       	mov    $0x80111d54,%edx
80103e4d:	eb 0c                	jmp    80103e5b <exit+0xcb>
80103e4f:	90                   	nop
80103e50:	83 c2 7c             	add    $0x7c,%edx
80103e53:	81 fa 54 3c 11 80    	cmp    $0x80113c54,%edx
80103e59:	74 33                	je     80103e8e <exit+0xfe>
    if(p->parent == curproc){
80103e5b:	39 5a 14             	cmp    %ebx,0x14(%edx)
...
80104c04:	68 fc 7a 10 80       	push   $0x80107afc
...
80104c1c:	68 fb 7a 10 80       	push   $0x80107afb
...
80104c31:	68 ef 7a 10 80       	push   $0x80107aef
...
80104c4f:	68 fe 7a 10 80       	push   $0x80107afe
80104c54:	e8 27 b7 ff ff       	call   80100380 <panic>
    panic("create: ialloc");
80104c59:	83 ec 0c             	sub    $0xc,%esp
80104c5c:	68 e0 7a 10 80       	push   $0x80107ae0
...
8010505d:	58                   	pop    %eax
8010505e:	5a                   	pop    %edx
8010505f:	68 fc 7a 10 80       	push   $0x80107afc
...
80105078:	68 fb 7a 10 80       	push   $0x80107afb
...
8010585b:	78 08                	js     80105865 <sys_shm_attach+0x25>
  }
  if(slt > 9)
8010585d:	8b 5d f4             	mov    -0xc(%ebp),%ebx
80105860:	83 fb 09             	cmp    $0x9,%ebx
80105863:	7e 0b                	jle    80105870 <sys_shm_attach+0x30>
  {
    return 0;
  }
  return shmattach(myproc(), slt);
}
...
8010586a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
  return shmattach(myproc(), slt);
80105870:	e8 fb e0 ff ff       	call   80103970 <myproc>
80105875:	83 ec 08             	sub    $0x8,%esp
80105878:	53                   	push   %ebx
80105879:	50                   	push   %eax
8010587a:	e8 21 1a 00 00       	call   801072a0 <shmattach>
}
...
80105893:	53                   	push   %ebx
  char *vaddr;
  if(argptr(0, &vaddr, PGSIZE) < 0)
80105894:	8d 45 f4             	lea    -0xc(%ebp),%eax
{
80105897:	83 ec 18             	sub    $0x18,%esp
  if(argptr(0, &vaddr, PGSIZE) < 0)
8010589a:	68 00 10 00 00       	push   $0x1000
8010589f:	50                   	push   %eax
801058a0:	6a 00                	push   $0x0
801058a2:	e8 c9 f0 ff ff       	call   80104970 <argptr>
801058a7:	83 c4 10             	add    $0x10,%esp
801058aa:	89 c2                	mov    %eax,%edx
801058ac:	31 c0                	xor    %eax,%eax
801058ae:	85 d2                	test   %edx,%edx
801058b0:	78 15                	js     801058c7 <sys_shm_detach+0x37>
  {
    return 0;
  }
  return shmdetach(myproc(), vaddr);
801058b2:	8b 5d f4             	mov    -0xc(%ebp),%ebx
801058b5:	e8 b6 e0 ff ff       	call   80103970 <myproc>
801058ba:	83 ec 08             	sub    $0x8,%esp
801058bd:	53                   	push   %ebx
801058be:	50                   	push   %eax
801058bf:	e8 7c 1a 00 00       	call   80107340 <shmdetach>
801058c4:	83 c4 10             	add    $0x10,%esp
801058c7:	8b 5d fc             	mov    -0x4(%ebp),%ebx
801058ca:	c9                   	leave  
801058cb:	c3                   	ret    
...
8010593e:	00 00 ef 
  initlock(&tickslock, "time");
80105941:	68 41 7b 10 80       	push   $0x80107b41
...
801059c4:	ff 24 85 e8 7b 10 80 	jmp    *-0x7fef8418(,%eax,4)
...
80105aa5:	68 a4 7b 10 80       	push   $0x80107ba4
...
80105af7:	68 4c 7b 10 80       	push   $0x80107b4c
...
80105c13:	68 70 7b 10 80       	push   $0x80107b70
80105c18:	e8 83 aa ff ff       	call   801006a0 <cprintf>
      panic("trap");
80105c1d:	83 c4 14             	add    $0x14,%esp
80105c20:	68 46 7b 10 80       	push   $0x80107b46
...
80105ccc:	83 ec 08             	sub    $0x8,%esp
  for(p="xv6...\n"; *p; p++)
80105ccf:	bf 68 7c 10 80       	mov    $0x80107c68,%edi
...
801068cf:	68 26 76 10 80       	push   $0x80107626
...
801069bd:	68 70 7c 10 80       	push   $0x80107c70
...
80106a60:	a1 08 45 11 80       	mov    0x80114508,%eax
...
80106beb:	68 b5 7c 10 80       	push   $0x80107cb5
...
80106c50:	68 cf 7c 10 80       	push   $0x80107ccf
...
80106cd8:	68 70 7d 10 80       	push   $0x80107d70
...
80106d79:	68 ed 7c 10 80       	push   $0x80107ced
...
80106ebc:	68 21 7d 10 80       	push   $0x80107d21
...
80106f5b:	a3 08 45 11 80       	mov    %eax,0x80114508
  lcr3(V2P(kpgdir));   // switch to the kernel page table
...
80106f8c:	68 32 7d 10 80       	push   $0x80107d32
...
80107002:	68 3c 7d 10 80       	push   $0x80107d3c
...
801070d7:	68 56 7d 10 80       	push   $0x80107d56
...
80107104:	0f 84 88 02 00 00    	je     80107392 <uva2ka.cold>
  return &pgtab[PTX(va)];
...
801071bd:	0f 84 d6 01 00 00    	je     80107399 <copyout.cold>
  return &pgtab[PTX(va)];
...
80107210 <allocate_shared_pages>:

void allocate_shared_pages()
{
...
80107219:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  {
    // populating array of shared pages
    // this function is called in kinit2(.) in kalloc.c..
    slot_pas[i] = V2P((uint)kalloc());
80107220:	e8 5b b4 ff ff       	call   80102680 <kalloc>
80107225:	05 00 00 00 80       	add    $0x80000000,%eax
8010722a:	89 04 9d e0 44 11 80 	mov    %eax,-0x7feebb20(,%ebx,4)
  for (int i = 0; i < 10; i++)
80107231:	83 c3 01             	add    $0x1,%ebx
80107234:	83 fb 0a             	cmp    $0xa,%ebx
80107237:	75 e7                	jne    80107220 <allocate_shared_pages+0x10>
  }
}
80107239:	8b 5d fc             	mov    -0x4(%ebp),%ebx
8010723c:	c9                   	leave  
8010723d:	c3                   	ret    
8010723e:	66 90                	xchg   %ax,%ax

80107240 <shared_memory_cleanup>:

void shared_memory_cleanup(struct proc* p)
{ 
80107240:	55                   	push   %ebp
80107241:	89 e5                	mov    %esp,%ebp
80107243:	53                   	push   %ebx
80107244:	8b 4d 08             	mov    0x8(%ebp),%ecx
  pte_t *pte;
  uint a;

  a = 0;
  for (; a < p->sz; a += PGSIZE)
80107247:	8b 01                	mov    (%ecx),%eax
80107249:	85 c0                	test   %eax,%eax
8010724b:	74 43                	je     80107290 <shared_memory_cleanup+0x50>
  a = 0;
8010724d:	31 c0                	xor    %eax,%eax
8010724f:	90                   	nop
  if(*pde & PTE_P){
80107250:	8b 51 04             	mov    0x4(%ecx),%edx
  pde = &pgdir[PDX(va)];
80107253:	89 c3                	mov    %eax,%ebx
80107255:	c1 eb 16             	shr    $0x16,%ebx
  if(*pde & PTE_P){
80107258:	8b 14 9a             	mov    (%edx,%ebx,4),%edx
8010725b:	f6 c2 01             	test   $0x1,%dl
8010725e:	74 27                	je     80107287 <shared_memory_cleanup+0x47>
  return &pgtab[PTX(va)];
80107260:	89 c3                	mov    %eax,%ebx
    pgtab = (pte_t*)P2V(PTE_ADDR(*pde));
80107262:	81 e2 00 f0 ff ff    	and    $0xfffff000,%edx
  return &pgtab[PTX(va)];
80107268:	c1 eb 0a             	shr    $0xa,%ebx
8010726b:	81 e3 fc 0f 00 00    	and    $0xffc,%ebx
80107271:	8d 94 1a 00 00 00 80 	lea    -0x80000000(%edx,%ebx,1),%edx
  {
    pte = walkpgdir(p->pgdir, (char *)a, 0);
    if(pte && (*pte & PTE_S)){
80107278:	85 d2                	test   %edx,%edx
8010727a:	74 0b                	je     80107287 <shared_memory_cleanup+0x47>
8010727c:	f6 02 08             	testb  $0x8,(%edx)
8010727f:	74 06                	je     80107287 <shared_memory_cleanup+0x47>
      *pte = 0;   // remove shared page from process's page table
80107281:	c7 02 00 00 00 00    	movl   $0x0,(%edx)
  for (; a < p->sz; a += PGSIZE)
80107287:	05 00 10 00 00       	add    $0x1000,%eax
8010728c:	39 01                	cmp    %eax,(%ecx)
8010728e:	77 c0                	ja     80107250 <shared_memory_cleanup+0x10>
                  // this is to avoid the page being freed by deallocuvm(.) in proc.c
    }
  }
}
...
uint
shmattach(struct proc *p, int slot)
{
...
801072a9:	8b 75 08             	mov    0x8(%ebp),%esi
  pte_t *pte;
  uint a = PGSIZE * ((p->sz/PGSIZE));
801072ac:	8b 06                	mov    (%esi),%eax
  pde = &pgdir[PDX(va)];
801072ae:	8b 56 04             	mov    0x4(%esi),%edx
801072b1:	89 c1                	mov    %eax,%ecx
  uint a = PGSIZE * ((p->sz/PGSIZE));
801072b3:	89 c7                	mov    %eax,%edi
  pde = &pgdir[PDX(va)];
801072b5:	c1 e9 16             	shr    $0x16,%ecx
  uint a = PGSIZE * ((p->sz/PGSIZE));
801072b8:	81 e7 00 f0 ff ff    	and    $0xfffff000,%edi
  pde = &pgdir[PDX(va)];
801072be:	8d 14 8a             	lea    (%edx,%ecx,4),%edx
  if(*pde & PTE_P){
801072c1:	8b 1a                	mov    (%edx),%ebx
801072c3:	f6 c3 01             	test   $0x1,%bl
801072c6:	74 38                	je     80107300 <shmattach+0x60>
    pgtab = (pte_t*)P2V(PTE_ADDR(*pde));
...
801072ce:	81 c3 00 00 00 80    	add    $0x80000000,%ebx
  ...
  *pte = slot_pas[slot] | PTE_P | PTE_W | PTE_U | PTE_S;
801072d4:	8b 55 0c             	mov    0xc(%ebp),%edx
  p->sz += PGSIZE;
801072d7:	05 00 10 00 00       	add    $0x1000,%eax
801072dc:	89 06                	mov    %eax,(%esi)
  return &pgtab[PTX(va)];
801072de:	89 f8                	mov    %edi,%eax
  *pte = slot_pas[slot] | PTE_P | PTE_W | PTE_U | PTE_S;
801072e0:	8b 14 95 e0 44 11 80 	mov    -0x7feebb20(,%edx,4),%edx
  return &pgtab[PTX(va)];
801072e7:	c1 e8 0c             	shr    $0xc,%eax
801072ea:	25 ff 03 00 00       	and    $0x3ff,%eax
  *pte = slot_pas[slot] | PTE_P | PTE_W | PTE_U | PTE_S;
801072ef:	83 ca 0f             	or     $0xf,%edx
801072f2:	89 14 83             	mov    %edx,(%ebx,%eax,4)
...
801072fe:	c3                   	ret    
801072ff:	90                   	nop
80107300:	89 55 e4             	mov    %edx,-0x1c(%ebp)
    if(!alloc || (pgtab = (pte_t*)kalloc()) == 0)
80107303:	e8 78 b3 ff ff       	call   80102680 <kalloc>
80107308:	89 c3                	mov    %eax,%ebx
8010730a:	85 c0                	test   %eax,%eax
8010730c:	0f 84 8e 00 00 00    	je     801073a0 <shmattach.cold>
    memset(pgtab, 0, PGSIZE);
80107312:	83 ec 04             	sub    $0x4,%esp
80107315:	68 00 10 00 00       	push   $0x1000
8010731a:	6a 00                	push   $0x0
8010731c:	50                   	push   %eax
8010731d:	e8 3e d3 ff ff       	call   80104660 <memset>
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
80107322:	8b 55 e4             	mov    -0x1c(%ebp),%edx
80107325:	8d 83 00 00 00 80    	lea    -0x80000000(%ebx),%eax
  p->sz += PGSIZE;
8010732b:	83 c4 10             	add    $0x10,%esp
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
8010732e:	83 c8 07             	or     $0x7,%eax
80107331:	89 02                	mov    %eax,(%edx)
  p->sz += PGSIZE;
80107333:	8b 06                	mov    (%esi),%eax
80107335:	eb 9d                	jmp    801072d4 <shmattach+0x34>
...
int 
shmdetach(struct proc *p, char *addr)
{
...
80107347:	8b 45 0c             	mov    0xc(%ebp),%eax
  if(*pde & PTE_P){
8010734a:	8b 4a 04             	mov    0x4(%edx),%ecx
  pde = &pgdir[PDX(va)];
8010734d:	89 c3                	mov    %eax,%ebx
8010734f:	c1 eb 16             	shr    $0x16,%ebx
  if(*pde & PTE_P){
80107352:	8b 0c 99             	mov    (%ecx,%ebx,4),%ecx
      return 0;
  ...
  {
    return -1;
80107355:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
  if(*pde & PTE_P){
8010735a:	f6 c1 01             	test   $0x1,%cl
8010735d:	74 2c                	je     8010738b <shmdetach+0x4b>
  return &pgtab[PTX(va)];
8010735f:	c1 e8 0a             	shr    $0xa,%eax
    pgtab = (pte_t*)P2V(PTE_ADDR(*pde));
80107362:	81 e1 00 f0 ff ff    	and    $0xfffff000,%ecx
  return &pgtab[PTX(va)];
80107368:	25 fc 0f 00 00       	and    $0xffc,%eax
8010736d:	8d 84 01 00 00 00 80 	lea    -0x80000000(%ecx,%eax,1),%eax
  if(pte && (*pte & PTE_S)){
80107374:	85 c0                	test   %eax,%eax
80107376:	74 13                	je     8010738b <shmdetach+0x4b>
80107378:	f6 00 08             	testb  $0x8,(%eax)
8010737b:	74 0e                	je     8010738b <shmdetach+0x4b>
      *pte = 0;
8010737d:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
      return 0;
80107383:	31 db                	xor    %ebx,%ebx
      p->sz -= PGSIZE;
80107385:	81 2a 00 10 00 00    	subl   $0x1000,(%edx)
  }

}
8010738b:	89 d8                	mov    %ebx,%eax
8010738d:	8b 5d fc             	mov    -0x4(%ebp),%ebx
80107390:	c9                   	leave  
80107391:	c3                   	ret    

80107392 <uva2ka.cold>:
  if((*pte & PTE_P) == 0)
80107392:	a1 00 00 00 00       	mov    0x0,%eax
80107397:	0f 0b                	ud2    

80107399 <copyout.cold>:
80107399:	a1 00 00 00 00       	mov    0x0,%eax
8010739e:	0f 0b                	ud2    

801073a0 <shmattach.cold>:
  p->sz += PGSIZE;
801073a0:	81 06 00 10 00 00    	addl   $0x1000,(%esi)
  *pte = slot_pas[slot] | PTE_P | PTE_W | PTE_U | PTE_S;
801073a6:	c7 05 00 00 00 00 00 	movl   $0x0,0x0
801073ad:	00 00 00 
801073b0:	0f 0b                	ud2    
